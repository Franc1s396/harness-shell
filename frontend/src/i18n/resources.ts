const en = {
  common: {
    appName: "Harness SSH", cancel: "Cancel", save: "Save",
  ...
  activity: { settings: "Settings", filesUnavailable: "Files are not available yet" },
  connections: {
  ...
  terminal: {
    ...
    closeConnectedBody: "The tab will close immediately. Harness SSH will close its PTY and disconnect SSH in the background.",
  ...
  agent: {
    imageAdd: "Add photos", imagePreview: "Image preview", imageUploading: "Uploading image", imageRemove: "Remove image", imageFailed: "Upload failed", imageRetry: "Retry upload", imageLoading: "Loading image",
    title: "Agent", expand: "Expand Agent information", collapse: "Collapse Agent information", boundary: "The Agent channel remains isolated from this human PTY.",
    message: "Message", messagePlaceholder: "Ask Agent to inspect or operate on this SSH session…", provider: "Provider", chooseProvider: "Choose Provider", providerSettings: "Provider settings", openProviderSettings: "Open Provider settings", send: "Send message", cancelResponse: "Cancel response", cancelled: "Cancelled", copy: "Copy", copied: "Copied", copyFailed: "Could not copy to clipboard.", retry: "Retry", retryTitle: "Resend this message?", retryBody: "This will replace the current reply and run this message again. Commands may execute again; previous changes will not be undone.", confirmRetry: "Resend", enterToSend: "Enter to send · Shift+Enter for newline", running: "Receiving response…", thinking: "Thinking…", toolExecuting: "Executing tool…", approvalHistory: "Approval history ({{count}})", pendingApproval: "Pending approval", executedTools: "Executed tools ({{count}})", newConversation: "New conversation", resetTitle: "Start a new conversation?", resetBody: "This clears only the current tab's in-memory conversation view.", confirmReset: "Start new conversation", approvalReject: "Reject", approvalApprove: "Approve", approvalOperation: "Run the following command on this connection", approvalStatusPENDING: "Awaiting approval", approvalStatusAPPROVED: "Approved (execution not confirmed)", approvalStatusREJECTED: "Rejected", approvalStatusINVALIDATED: "Inactive", approvalStatusUNKNOWN: "Decision or execution unconfirmed", emptySession: "Select a connected terminal tab to use Agent.", emptyProvider: "Configure and select an enabled Provider before sending.", runDetails: "Run details", sentSnapshot: "Sent snapshot", runId: "Run ID", runStatus: "Status", iteration: "Iteration", session: "Session", apiType: "API type", model: "Model", noMessages: "No messages in this tab.", completedAnnouncement: "Agent completed for {{name}}", failedAnnouncement: "Agent failed for {{name}}", tabAwaitingApproval: "{{name}} is awaiting approval", tabRunning: "Agent running for {{name}}", tabCompleted: "Agent completed for {{name}}", tabFailed: "Agent failed for {{name}}", activeRunTitle: "Agent Run is still active", activeRunBody: "{{name}} still owns an active Agent Run.",
  },
  settings: { language: "Language", general: "General", close: "Close settings", diagnostics: { title: "Diagnostics", description: "Harness SSH writes local application and Agent logs here.", loading: "Checking log directory…", available: "The log directory is available.", open: "Open log directory", opening: "Opening…" }, modelProviders: { advancedSettings: "Advanced settings", contextWindowSize: "Context window size", contextCompactionThresholdPercent: "Compaction threshold (%)", maxOutputTokens: "Maximum output tokens", contextBudgetHelp: "At the threshold, summarize history before a new turn; reserve output tokens within the window.", title: "Model Providers", newProvider: "New Provider", empty: "No model providers configured.", loading: "Loading providers…", retry: "Retry", enabled: "Enabled", disabled: "Disabled", storedKey: "API Key safely stored", activeRun: "In use by an active Run", createTitle: "New Provider", editTitle: "Edit Provider", deleteTitle: "Delete Provider?", deleteBody: "Delete {{name}} and its stored API Key?", confirmDelete: "Confirm delete", displayName: "Display name", apiType: "API type", baseUrl: "Base URL", model: "Model", apiKey: "API Key", keepCurrentKey: "Leave blank to keep the current API Key", required: "Required", invalid: "Invalid value", save: "Save", primaryFailure: "Provider operation failed" } },
...
const zhCN = {
  common: { appName: "Harness SSH", cancel: "取消", save: "保存", saveAndConnect: "保存并连接", delete: "删除", close: "关闭", copyDetails: "复制详情", copied: "已复制" },
  nav: { connections: "SSH 连接", files: "文件", sftp: "SFTP", settings: "设置", agent: "AI Agent" },
  shell: { primaryActivities: "主要活动", resizeSidebar: "调整连接侧栏宽度", resizeAgent: "调整 Agent 工作区宽度" },
  applicationClose: { title: "退出 Harness SSH？", body: "关闭程序将结束当前工作区和所有会话。", confirm: "退出 Harness SSH", activeTransferBody: "仍有用户手动 SFTP 传输正在进行。请继续等待，或取消传输并等待清理完成后再退出。", committingBody: "用户手动 SFTP 传输正在提交，已不能安全取消。请继续等待传输完成。", recoveryBody: "传输清理未能完成。受保护的恢复记录会保留到下次启动。", continueWaiting: "继续等待", cancelAndCleanUp: "取消并清理", keepRecoveryAndClose: "保留恢复记录并关闭", activeAgentBody: "仍有 {{count}} 个 Agent Run 正在运行。退出后远程结果可能未知。", forceExit: "强制退出" },
  ...
  activity: { settings: "设置", filesUnavailable: "文件功能暂未提供" },
  ...
  agent: {
    imageAdd: "添加照片", imagePreview: "图片预览", imageUploading: "图片上传中", imageRemove: "移除图片", imageFailed: "上传失败", imageRetry: "重新上传", imageLoading: "正在加载图片", title: "Agent", expand: "展开 Agent 说明", collapse: "折叠 Agent 说明", boundary: "Agent channel 与此人工 PTY 保持隔离。", message: "消息", messagePlaceholder: "让 Agent 检查或操作当前 SSH 会话…", provider: "Provider", chooseProvider: "选择 Provider", providerSettings: "Provider 设置", openProviderSettings: "打开 Provider 设置", send: "发送消息", cancelResponse: "取消回答", cancelled: "已取消", copy: "复制", copied: "已复制", copyFailed: "无法复制到剪贴板。", retry: "重试", retryTitle: "重新发送这条消息？", retryBody: "将替换当前回复并重新执行这条消息。命令可能再次执行，之前已产生的变更不会撤销。", confirmRetry: "重新发送", enterToSend: "Enter 发送 · Shift+Enter 换行", running: "正在接收回答…", thinking: "思考中…", toolExecuting: "工具执行中…", approvalHistory: "审核记录（{{count}}）", pendingApproval: "待审核操作", executedTools: "执行工具（{{count}}）", newConversation: "新对话", resetTitle: "开始新对话？", resetBody: "这只会清除当前标签内存中的对话视图。", confirmReset: "开始新对话", approvalReject: "拒绝", approvalApprove: "通过", approvalOperation: "将在此连接执行以下命令", approvalStatusPENDING: "等待审核", approvalStatusAPPROVED: "已通过（不代表执行成功）", approvalStatusREJECTED: "已拒绝", approvalStatusINVALIDATED: "已失效", approvalStatusUNKNOWN: "决定或执行状态未确认", emptySession: "请选择一个已连接的终端标签以使用 Agent。", emptyProvider: "发送前请配置并选择已启用的 Provider。", runDetails: "Run 详情", sentSnapshot: "本轮发送快照", runId: "Run ID", runStatus: "状态", iteration: "迭代次数", session: "会话", apiType: "API 类型", model: "模型", noMessages: "当前标签还没有消息。", completedAnnouncement: "Agent 已为 {{name}} 完成", failedAnnouncement: "Agent 在 {{name}} 上失败", tabAwaitingApproval: "{{name}} 正在等待审核", tabRunning: "Agent 正在为 {{name}} 运行", tabCompleted: "Agent 已为 {{name}} 完成", tabFailed: "Agent 在 {{name}} 上失败", activeRunTitle: "Agent Run 仍在运行", activeRunBody: "{{name}} 仍有一个活动 Agent Run。" },
  settings: { language: "语言", general: "常规", close: "关闭设置", diagnostics: { title: "诊断", description: "Harness SSH 会将本地应用和 Agent 日志写入此处。", loading: "正在检查日志目录…", available: "日志目录可用。", open: "打开日志目录", opening: "正在打开…" }, modelProviders: { advancedSettings: "高级设置", contextWindowSize: "上下文窗口大小", contextCompactionThresholdPercent: "压缩触发百分比 (%)", maxOutputTokens: "最大输出 token", contextBudgetHelp: "达到阈值时，在新一轮开始前压缩历史；窗口内需预留输出 token。", title: "模型 Provider", newProvider: "新建 Provider", empty: "尚未配置模型 Provider。", loading: "正在加载 Provider…", retry: "重试", enabled: "已启用", disabled: "已禁用", storedKey: "API Key 已安全保存", activeRun: "正在被活动 Run 使用", createTitle: "新建 Provider", editTitle: "编辑 Provider", deleteTitle: "删除 Provider？", deleteBody: "删除 {{name}} 及其已保存的 API Key？", confirmDelete: "确认删除", displayName: "显示名称", apiType: "API 类型", baseUrl: "Base URL", model: "模型", apiKey: "API Key", keepCurrentKey: "留空以保留当前 API Key", required: "必填", invalid: "值无效", save: "保存", primaryFailure: "Provider 操作失败" } },
...
const zhTW = {
  common: { appName: "Harness SSH", cancel: "取消", save: "儲存", saveAndConnect: "儲存並連線", delete: "刪除", close: "關閉", copyDetails: "複製詳情", copied: "已複製" },
  nav: { connections: "SSH 連線", files: "檔案", sftp: "SFTP", settings: "設定", agent: "AI Agent" },
  shell: { primaryActivities: "主要活動", resizeSidebar: "調整連線側欄寬度", resizeAgent: "調整 Agent 工作區寬度" },
  applicationClose: { title: "退出 Harness SSH？", body: "關閉程式將結束目前工作區和所有工作階段。", confirm: "退出 Harness SSH", activeTransferBody: "仍有使用者手動 SFTP 傳輸正在進行。請繼續等待，或取消傳輸並等待清理完成後再退出。", committingBody: "使用者手動 SFTP 傳輸正在提交，已無法安全取消。請繼續等待傳輸完成。", recoveryBody: "傳輸清理未能完成。受保護的復原記錄會保留到下次啟動。", continueWaiting: "繼續等待", cancelAndCleanUp: "取消並清理", keepRecoveryAndClose: "保留復原記錄並關閉", activeAgentBody: "仍有 {{count}} 個 Agent Run 正在執行。退出後遠端結果可能未知。", forceExit: "強制退出" },
  ...
  activity: { settings: "設定", filesUnavailable: "檔案功能暫未提供" },
  ...
  terminal: { title: "互動式終端", runtimeReady: "Runtime ready", inputDisabled: "輸入已停用", emptyTitle: "尚未開啟終端", emptyBody: "請選擇連線或新增連線設定。", selectConnection: "選擇連線", createConnection: "新增連線", closeTab: "關閉 {{name}}", humanBoundary: "人工 PTY — 與 Agent 輸入隔離", sidecarUnavailable: "Sidecar 無法使用。現有 PTY 已中斷；未建立替代終端。", actions: "工作階段操作", reconnect: "重新連線", disconnect: "中斷連線", closeConfirmTitle: "關閉工作階段？", closeConnectedBody: "分頁會立即關閉。Harness SSH 將在背景關閉 PTY 並中斷 SSH。", closeLocalBody: "這將移除本機分頁及保留的終端輸出。", confirmClose: "關閉工作階段", reconnectDivider: "── 已重新連線 ──", cleanupFailed: "未能完成 {{name}} 的清理", retryCleanup: "重試清理", cleanupRetrying: "正在重試清理…", states: { connecting: "正在連線", hostKeyRequired: "等待 Host Key", connected: "已連線", disconnecting: "正在中斷", disconnected: "已中斷", failed: "連線失敗" } },
  ...
  agent: {
    imageAdd: "新增照片", imagePreview: "圖片預覽", imageUploading: "圖片上傳中", imageRemove: "移除圖片", imageFailed: "上傳失敗", imageRetry: "重新上傳", imageLoading: "正在載入圖片", title: "Agent", expand: "展開 Agent 說明", collapse: "收合 Agent 說明", boundary: "Agent channel 與此人工 PTY 保持隔離。", message: "訊息", messagePlaceholder: "讓 Agent 檢查或操作目前 SSH 工作階段…", provider: "Provider", chooseProvider: "選擇 Provider", providerSettings: "Provider 設定", openProviderSettings: "開啟 Provider 設定", send: "傳送訊息", cancelResponse: "取消回答", cancelled: "已取消", copy: "複製", copied: "已複製", copyFailed: "無法複製到剪貼簿。", retry: "重試", retryTitle: "重新傳送這則訊息？", retryBody: "將替換目前回覆並重新執行這則訊息。命令可能再次執行，先前已產生的變更不會撤銷。", confirmRetry: "重新傳送", enterToSend: "Enter 傳送 · Shift+Enter 換行", running: "正在接收回答…", thinking: "思考中…", toolExecuting: "工具執行中…", approvalHistory: "審核記錄（{{count}}）", pendingApproval: "待審核操作", executedTools: "執行工具（{{count}}）", newConversation: "新對話", resetTitle: "開始新對話？", resetBody: "這只會清除目前分頁記憶體中的對話檢視。", confirmReset: "開始新對話", approvalReject: "拒絕", approvalApprove: "通過", approvalOperation: "將在此連線執行以下命令", approvalStatusPENDING: "等待審核", approvalStatusAPPROVED: "已通過（不代表執行成功）", approvalStatusREJECTED: "已拒絕", approvalStatusINVALIDATED: "已失效", approvalStatusUNKNOWN: "決定或執行狀態未確認", emptySession: "請選擇一個已連線的終端分頁以使用 Agent。", emptyProvider: "傳送前請設定並選擇已啟用的 Provider。", runDetails: "Run 詳情", sentSnapshot: "本輪傳送快照", runId: "Run ID", runStatus: "狀態", iteration: "迭代次數", session: "工作階段", apiType: "API 類型", model: "模型", noMessages: "目前分頁還沒有訊息。", completedAnnouncement: "Agent 已為 {{name}} 完成", failedAnnouncement: "Agent 在 {{name}} 上失敗", tabAwaitingApproval: "{{name}} 正在等待審核", tabRunning: "Agent 正在為 {{name}} 執行", tabCompleted: "Agent 已為 {{name}} 完成", tabFailed: "Agent 在 {{name}} 上失敗", activeRunTitle: "Agent Run 仍在執行", activeRunBody: "{{name}} 仍有一個作用中的 Agent Run。" },
  settings: { language: "語言", general: "一般", close: "關閉設定", diagnostics: { title: "診斷", description: "Harness SSH 會將本機應用程式和 Agent 日誌寫入此處。", loading: "正在檢查日誌目錄…", available: "日誌目錄可用。", open: "開啟日誌目錄", opening: "正在開啟…" }, modelProviders: { advancedSettings: "進階設定", contextWindowSize: "上下文視窗大小", contextCompactionThresholdPercent: "壓縮觸發百分比 (%)", maxOutputTokens: "最大輸出 token", contextBudgetHelp: "達到門檻時，在新一輪開始前壓縮歷史；視窗內需預留輸出 token。", title: "模型 Provider", newProvider: "新增 Provider", empty: "尚未設定模型 Provider。", loading: "正在載入 Provider…", retry: "重試", enabled: "已啟用", disabled: "已停用", storedKey: "API Key 已安全儲存", activeRun: "正在被作用中的 Run 使用", createTitle: "新增 Provider", editTitle: "編輯 Provider", deleteTitle: "刪除 Provider？", deleteBody: "刪除 {{name}} 及其已儲存的 API Key？", confirmDelete: "確認刪除", displayName: "顯示名稱", apiType: "API 類型", baseUrl: "Base URL", model: "模型", apiKey: "API Key", keepCurrentKey: "留空以保留目前 API Key", required: "必填", invalid: "數值無效", save: "儲存", primaryFailure: "Provider 操作失敗" } },
