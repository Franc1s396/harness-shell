...
const zhTW = {
  ...
  agent: { title: "Agent", unavailable: "M2 尚未啟用 Agent", expand: "展開 Agent 說明", collapse: "收合 Agent 說明", boundary: "Agent channel 與此人工 PTY 保持隔離。", unavailableTitle: "Agent 將於 M3 提供", unavailableBody: "目前 M2 工作區不執行 Agent 任務。", message: "訊息", messagePlaceholder: "讓 Agent 檢查或操作目前 SSH 工作階段…", provider: "Provider", chooseProvider: "選擇 Provider", providerSettings: "Provider 設定", openProviderSettings: "開啟 Provider 設定", send: "傳送訊息", cancelResponse: "取消回答", cancelled: "已取消", enterToSend: "Enter 傳送 · Shift+Enter 換行", running: "正在接收回答…", thinking: "思考中…", toolExecuting: "工具執行中…", approvalHistory: "審核記錄（{{count}}）", pendingApproval: "待審核操作", executedTools: "執行工具（{{count}}）", newConversation: "新對話", resetTitle: "開始新對話？", resetBody: "這只會清除目前分頁記憶體中的對話檢視。", confirmReset: "開始新對話", approvalReject: "拒絕", approvalApprove: "通過", approvalOperation: "將在此連線執行以下命令", approvalStatusPENDING: "等待審核", approvalStatusAPPROVED: "已通過（不代表執行成功）", approvalStatusREJECTED: "已拒絕", approvalStatusINVALIDATED: "已失效", approvalStatusUNKNOWN: "決定或執行狀態未確認", emptySession: "請選擇一個已連線的終端分頁以使用 Agent。", emptyProvider: "傳送前請設定並選擇已啟用的 Provider。", runDetails: "Run 詳情", sentSnapshot: "本輪傳送快照", runId: "Run ID", runStatus: "狀態", iteration: "迭代次數", session: "工作階段", apiType: "API 類型", model: "模型", noMessages: "目前分頁還沒有訊息。", completedAnnouncement: "Agent 已為 {{name}} 完成", failedAnnouncement: "Agent 在 {{name}} 上失敗", tabAwaitingApproval: "{{name}} 正在等待審核", tabRunning: "Agent 正在為 {{name}} 執行", tabCompleted: "Agent 已為 {{name}} 完成", tabFailed: "Agent 在 {{name}} 上失敗", activeRunTitle: "Agent Run 仍在執行", activeRunBody: "{{name}} 仍有一個作用中的 Agent Run。" },
