const en = {
  ...
  agent: {
    ...
    errors: { UI_AGENT_ACTIVE_SESSION_REQUIRED: "A connected SSH Session is required.", UI_AGENT_PROVIDER_REQUIRED: "Select an enabled Provider.", UI_AGENT_PROVIDER_UNAVAILABLE: "The selected Provider is no longer available.", UI_AGENT_MESSAGE_INVALID: "Message length must be between 1 and 65536 characters.", UI_MODEL_API_CONFIG_ACTIVE_RUN: "The Provider is in use by an active Run.", BACKEND_AGENT_STREAM_INVALID: "The Agent stream used an invalid protocol.", BACKEND_AGENT_STREAM_TOO_LARGE: "The Agent stream exceeded the allowed size.", AGENT_STREAM_INTERRUPTED: "The Agent stream ended before completion." },
  },
