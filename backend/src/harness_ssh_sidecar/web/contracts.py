...
from harness_ssh_sidecar.agent.handlers import (
    AgentTurnRequest,
...
from harness_ssh_sidecar.connections.handlers import (
...
from harness_ssh_sidecar.ssh.models import HostKeyInspectionRequest, SshConnectRequest
...
def build_openapi_document() -> dict[str, object]:
    ...
    settings = RuntimeSettings.from_data_dir(Path("C:/harness-ssh-contract"))
